...
export function LegalPage({
  ...
  return (
    <>
      {/* HEADER */}
      <section style={{ background: "var(--hb-navy)" }} className="py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="display-heading text-white" style={{ fontSize: "clamp(1.8rem,3.5vw,2.8rem)" }}>{title}</h1>
      ...
      <div className="bg-slate-50 py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-[1fr,288px] lg:items-start">
            ...
            {/* Main article */}
            <article className="legal-content rounded-2xl bg-white p-8 shadow-sm lg:p-10">
              {children}
            </article>
            ...
            <aside className="space-y-5 lg:sticky lg:top-24">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm" style={{ border: "1px solid #e2e8f0" }}>
                <h3 className="mb-4 font-bold text-slate-900">Bezpośredni kontakt</h3>
                ...
                <div className="mt-5">
                  <p className="mb-1.5 text-xs text-slate-500">Firma Usługowo Handlowa DIUNA<br />Leszek Białasik<br />ul. 17 Stycznia 5/1, 64-400 Międzychód<br />NIP: 5951211839</p>
                </div>
                <div className="mt-5">
                  <Link href="/darmowa-konsultacja" className="btn-pulse flex w-full items-center justify-center gap-2 rounded-full py-3 text-sm font-bold text-white" style={{ background: "var(--hb-water)" }}>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm" style={{ border: "1px solid #e2e8f0" }}>
                ...
                <ul className="space-y-2">
                  {LEGAL_LINKS.map((l) => (
                    <li key={l.href}>
                      <Link href={l.href} className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-slate-600 transition-colors hover:bg-slate-50 hover:text-[#0284c7]">
