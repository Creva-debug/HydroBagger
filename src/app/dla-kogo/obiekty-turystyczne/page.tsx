...
export async function generateMetadata(): Promise<Metadata> {
  return getPageMetadata("/dla-kogo/obiekty-turystyczne");
}
      ...
      areas={[
        {
          ...
          title: "Czyszczenie akwenów przy obiekcie",
          body: "Usuwamy trzcinę i zakrzaczenia ze stawów i linii brzegowej – bez szkody dla estetyki i bez zakłócania pracy obiektu.",
        },
        {
